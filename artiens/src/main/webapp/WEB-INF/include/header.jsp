              	 	...
              	 	<li class="menu-item">
                		<a class="menu-link" style="font-size: larger;" href="work.jsp">
               	 		...
               	 		<ul class="sub-menu-container bg-light" >
               	 			...
               	 			<li class="menu-item">
               	 				<c:if test="${nickname ne null }"><a class="menu-link" href="/artizen/blog/${nickname }">내 블로그</a></c:if>
               	 				<c:if test="${nickname eq null }"><a class="menu-link" href="/artizen/artwork/main">내 블로그</a></c:if>
               	 			</li>
               	 			<li class="menu-item">
